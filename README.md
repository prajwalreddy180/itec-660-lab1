...
11. Questions
    1. Update the readme file by answering the following questions and typing your answers in that file.
        ...
        Make the heading visually appealing and readable by changing font and color.
        Ensure images are appropriately sized and spaced using width, height and margin properties.
        use styles for different screen sizes to enhance usability by using the @media rule.
